...
class ElevatorModelFactoryTest {
	...
	@Test
	void testFactoryCreatesCorrectNumberOfElevators()
	...
	@Test
	void testFactorySetsCorrectElevatorNumbers()
			throws IllegalArgumentException, HardwareConnectionException, RemoteException {
	...
	@Test
	void testFactoryCreatesCorrectNumberOfFloors()
			throws IllegalArgumentException, HardwareConnectionException, RemoteException {
		when(iElevatorMock.getElevatorNum()).thenReturn(20);
		when(iElevatorMock.getFloorNum()).thenReturn(10);
		IElevatorManager man = new ElevatorHardwareManager(iElevatorMock);
	...
	@Test
	void testFactorySetsCorrectFloorNumbers()
			throws IllegalArgumentException, HardwareConnectionException, RemoteException {
		when(iElevatorMock.getElevatorNum()).thenReturn(20);
		when(iElevatorMock.getFloorNum()).thenReturn(10);
		IElevatorManager man = new ElevatorHardwareManager(iElevatorMock);
